...
public interface ReconfigurationProblem extends Solver {
    ...
    /**
     * Get the virtual machines that will be in the running state at the end of the reconfiguration
     * process.
     * 
    ...
    /**
     * Get the virtual machines that will be in the waiting state at the end of the reconfiguration
     * process.
     * 
     * @return a set, may be empty
     */
    ...
    /**
     * Get the virtual machines that will be in the sleeping state at the end of the reconfiguration
     * process.
     * 
     * @return a set, may be empty
     */
    ...
    /**
     * Get the virtual machines that will be in the terminated state at the end of the
    ...
    /**
     * Get the nodes that will be in the online state at the end of the reconfiguration process.
     * 
     * @return a set, may be empty
     */
    ...
    /**
     * Get the nodes that will be in the offline state at the end of the reconfiguration process.
     * 
     * @return a set, may be empty
     */
    ...
    /**
     * Get the variable associated to a group of VMs. If the group was not defined, it is created.
     * All the VMs must only belong to one group
     * 
     * @param vms the group of virtual machines.
     * @return the variable associated to the group or null if at least one VM of the proposed new
     *         group already belong to a group
     */
    ...
    /**
     * Get identifier associated to a group of nodes. If the group was not defined, it is created.
     * 
     * @param nodes the group to define
     * @return the value associated to the group. -1 if the maximum number of group of nodes has
     *         been reached.
     */
     ...
     */
    List<VirtualMachineActionModel> getAssociatedActions(
    ...
    /**
     * Extract the resulting reconfiguration plan if the solving process succeeded.
     * 
