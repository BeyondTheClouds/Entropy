	 ...
	 */
	 ...
	 public int getGroup(ManagedElementSet<Node> nodes) {
		 if (nodesGrp.get(nodes) != null) {
			 ...
			 for (Node n : nodes) {
				 TIntArrayList l = nodeGrps.get(getNode(n));
				 l.add(v);
				 grpId[getNode(n)] = v;
			 }
