...
public class Among implements PlacementConstraint {
    ...
    public ManagedElementSet<Node> getNodes() {
        ManagedElementSet<Node> alls = new SimpleManagedElementSet<Node>();
    ...
    public String toString() {
        ...
        buffer.append(", ").append(groups).append(')');
    ...
    public void inject(ReconfigurationProblem core) {
        ...
        if (groups.size() == 1) {
            ...
            IntDomainVar vmGrpId;
            vmGrpId = core.makeGroup(vms, groups);
            ...
            for (VirtualMachine vm : runnings) {
                ...
                if (assign.isInstantiated()) {
                    if (vmGrpId.isInstantiated()) {
                        if (vmGrpId.getVal() != core.getNodesGroupId()[assign.getVal()]) {
                    ...
                    SConstraint c = new Element(assign, core.getNodesGroupId(), vmGrpId);
                    core.post(c);
                }
            }
        }
